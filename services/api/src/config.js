...
export function loadConfig(overrides = {}) {
  ...
  const config = {
    ...
    geminiApiKeyFile: (process.env.LABORATORY_GEMINI_API_KEY_FILE ?? ".secrets/gemini-api-key.txt").trim()
      ? path.resolve(PROJECT_ROOT, (process.env.LABORATORY_GEMINI_API_KEY_FILE ?? ".secrets/gemini-api-key.txt").trim())
      : "",
